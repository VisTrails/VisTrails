...
def initialize(*args, **keywords):
    ...
    reg.addOutputPort(GradientMagnitudeRecursiveGaussianImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    ...
    reg.addOutputPort(RescaleIntensityImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    ...
    reg.addOutputPort(SigmoidImageFilter, "Filter", (Filter, 'Output Filter'))
    reg.addOutputPort(SigmoidImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    reg.addOutputPort(SigmoidImageFilter, "Output Dimension", (basic.Integer, 'Output Dimension'))
    ...
    reg.addOutputPort(IsolatedWatershedImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    ...
    reg.addOutputPort(CastImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    reg.addOutputPort(CastImageFilter, "Dimension", (basic.Integer, 'Dimension'))
    ...
    reg.addOutputPort(RegionOfInterestImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    reg.addOutputPort(RegionOfInterestImageFilter, "Filter", (Filter, 'Filter'))
    ...
    reg.addOutputPort(ExtractImageFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    reg.addOutputPort(ExtractImageFilter, "Dimension", (basic.Integer, 'Dimension'))
    ...
    reg.addOutputPort(CurvatureAnisotropicDiffusionFilter, "Output PixelType", (PixelType, 'Output PixelType'))
    reg.addOutputPort(CurvatureAnisotropicDiffusionFilter, "Output Dimension", (basic.Integer, 'Output Dimension'))

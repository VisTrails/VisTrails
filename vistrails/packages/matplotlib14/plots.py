...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("bottom", "basic:List",
               {'union': 'bottom', 'optional': True, 'docstring': 'the y coordinate(s) of the bars\n'}),
              ("bottomSequence", "basic:List",
               {'union': 'bottom', 'docstring': 'the y coordinate(s) of the bars\n', 'optional': True}),
              ("color", "basic:Color",
              ...
              ("height", "basic:List",
               {'union': 'height', 'docstring': 'the heights of the bars\n'}),
              ("heightScalar", "basic:Float",
               {'union': 'height', 'docstring': 'the heights of the bars\n', 'optional': True}),
              ("widthScalar", "basic:Float",
               {'union': 'width', 'optional': True, 'docstring': 'the width(s) of the bars\n', 'defaults': [0.8]}),
              ("widthSequence", "basic:List",
               {'union': 'width', 'docstring': 'the width(s) of the bars\n', 'optional': True}),
              ("log", "basic:Boolean",
              ...
              ("yerr", "basic:List",
               {'optional': True, 'docstring': 'if not None, will be used to generate errorbar(s) on the bar chart\n'}),
              ("left", "basic:List",
               {'union': 'left', 'optional': True, 'docstring': 'the x coordinates of the left sides of the bars\n'}),
              ("leftScalar", "basic:Float",
               {'union': 'left', 'optional': True, 'docstring': 'the x coordinate of the left side of the bar'}),
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("ecolor", "basic:Color",
               {'optional': True, 'docstring': 'specifies the color of errorbar(s)\n'}),
              ("heightScalar", "basic:Float",
               {'union': 'height', 'optional': True, 'docstring': 'the heights of the bars\n', 'defaults': [0.8]}),
              ...
              ("leftSequence", "basic:List",
               {'union': 'left', 'docstring': 'the x coordinates of the left sides of the bars', 'optional': True}),
              ("rectangleProperties", "MplRectangleProperties",
               {'optional': True}),
        ]
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("xerr", "basic:List",
               {'union': 'xerr', 'optional': True, 'docstring': 'If a scalar number, len(N) array-like object, or an Nx1 array-like object, errorbars are drawn +/- value.\n\nIf a sequence of shape 2xN, errorbars are drawn at -row1 and +row2'}),
              ("xerrScalar", "basic:Float",
               {'union': 'xerr', 'docstring': 'If a scalar number, len(N) array-like object, or an Nx1 array-like object, errorbars are drawn +/- value.\n\nIf a sequence of shape 2xN, errorbars are drawn at -row1 and +row2', 'optional': True}),
              ("fmt", "basic:String",
              ...
              ("hold", "basic:String",
               {'optional': True}),
              ("yerr", "basic:List",
               {'union': 'yerr', 'optional': True, 'docstring': 'If a scalar number, len(N) array-like object, or an Nx1 array-like object, errorbars are drawn +/- value.\n\nIf a sequence of shape 2xN, errorbars are drawn at -row1 and +row2'}),
              ("yerrScalar", "basic:Float",
               {'union': 'yerr', 'docstring': 'If a scalar number, len(N) array-like object, or an Nx1 array-like object, errorbars are drawn +/- value.\n\nIf a sequence of shape 2xN, errorbars are drawn at -row1 and +row2', 'optional': True}),
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ("y2", "basic:Float",
               {'union': 'y2', 'optional': True, 'docstring': 'A scalar y-value', 'defaults': [0]}),
              ("y2Sequence", "basic:List",
               {'union': 'y2', 'optional': True, 'docstring': 'An N-length array of the y data'}),
              ("interpolate", "basic:Boolean",
               {'optional': True, 'defaults': [False]}),
              ("y1", "basic:List",
               {'union': 'y1', 'docstring': 'An N-length array of the y data'}),
              ("y1Scalar", "basic:Float",
               {'union': 'y1', 'optional': True, 'docstring': 'A scalar y-value'}),
              ("x", "basic:List",
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("x2", "basic:Float",
               {'union': 'x2', 'optional': True, 'docstring': 'A scalar x-value', 'defaults': [0]}),
              ("x2Sequence", "basic:List",
               {'union': 'x2', 'optional': True, 'docstring': 'An N-length array of the x data'}),
              ("hold", "basic:String",
               {'optional': True}),
              ("x1", "basic:List",
               {'union': 'x1', 'docstring': 'An N-length array of the x data'}),
              ("x1Scalar", "basic:Float",
               {'union': 'x1', 'optional': True, 'docstring': 'A scalar x-value'}),
              ("where", "basic:List",
               {'optional': True, 'docstring': 'An N-length boolean array that specifies where the fill is effective'}),
              ("polyCollectionProperties", "MplPolyCollectionProperties",
               {'optional': True}),
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("binsScalar", "basic:Integer",
               {'union': 'bins', 'optional': True, 'docstring': 'If an integer is given, `bins + 1` bin edges are returned,\nconsistently with :func:`numpy.histogram` for numpy version >=\n1.3.\n\nUnequally spaced bins are supported if `bins` is a sequence.\n\ndefault is 10\n', 'defaults': [10]}),
              ("binsSequence", "basic:List",
               {'union': 'bins', 'docstring': 'If an integer is given, `bins + 1` bin edges are returned,\nconsistently with :func:`numpy.histogram` for numpy version >=\n1.3.\n\nUnequally spaced bins are supported if `bins` is a sequence.\n\ndefault is 10\n', 'optional': True}),
              ("log", "basic:Boolean",
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("xminScalar", "basic:List",
               {'union': 'xmin', 'docstring': 'Respective beginning and end of each line. If scalars are\nprovided, all lines will have same length.\n'}),
              ("xminSequence", "basic:List",
               {'union': 'xmin', 'docstring': 'Respective beginning and end of each line. If scalars are\nprovided, all lines will have same length.\n', 'optional': True}),
              ("colorsScalar", "basic:String",
               {'union': 'colors', 'optional': True, 'defaults': [u'k']}),
              ("colorsSequence", "basic:List",
               {'union': 'colors', 'optional': True}),
              ("xmaxScalar", "basic:List",
               {'union': 'xmax', 'docstring': 'can be scalars or len(x) numpy arrays.  If they are scalars, then the respective values are constant, else the widths of the lines are determined by xmin and xmax.'}),
              ("xmaxSequence", "basic:List",
               {'union': 'xmax', 'docstring': 'can be scalars or len(x) numpy arrays.  If they are scalars, then the respective values are constant, else the widths of the lines are determined by xmin and xmax.', 'optional': True}),
              ("kwargs", "basic:String",
               {'optional': True}),
              ("y", "basic:List",
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ...
              ("explodeSequence", "basic:List",
               {'union': 'explode', 'optional': True, 'docstring': 'If not None, is a len(x) array which specifies the fraction of the radius with which to offset each wedge.'}),
              ("explodeScalar", "basic:String",
               {'union': 'explode', 'docstring': 'If not None, is a len(x) array which specifies the fraction of the radius with which to offset each wedge.', 'optional': True}),
              ("colors", "basic:List",
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ("vmax", "basic:Float",
               {'optional': True, 'docstring': '`vmin` and `vmax` are used in conjunction with `norm` to normalize\nluminance data.  If either are `None`, the min and max of the\ncolor array is used.  Note if you pass a `norm` instance, your\nsettings for `vmin` and `vmax` will be ignored.\n'}),
              ("c", "basic:String",
               {'union': 'c', 'optional': True, 'docstring': '`c` can be a single color format string, or a sequence of color\nspecifications of length `N`, or a sequence of `N` numbers to be\nmapped to colors using the `cmap` and `norm` specified via kwargs\n(see below). Note that `c` should not be a single numeric RGB or\nRGBA sequence because that is indistinguishable from an array of\nvalues to be colormapped.  `c` can be a 2-D array in which the\nrows are RGB or RGBA, however.\n', 'defaults': [u'b']}),
              ("cSequence", "basic:List",
               {'union': 'c', 'docstring': '`c` can be a single color format string, or a sequence of color\nspecifications of length `N`, or a sequence of `N` numbers to be\nmapped to colors using the `cmap` and `norm` specified via kwargs\n(see below). Note that `c` should not be a single numeric RGB or\nRGBA sequence because that is indistinguishable from an array of\nvalues to be colormapped.  `c` can be a 2-D array in which the\nrows are RGB or RGBA, however.\n', 'optional': True}),
              ("vmin", "basic:Float",
               {'optional': True, 'docstring': '`vmin` and `vmax` are used in conjunction with `norm` to normalize\nluminance data.  If either are `None`, the min and max of the\ncolor array is used.  Note if you pass a `norm` instance, your\nsettings for `vmin` and `vmax` will be ignored.\n'}),
              ("kwargs", "basic:String",
               {'optional': True}),
              ...
              ("sScalar", "basic:Integer",
               {'union': 's', 'optional': True, 'docstring': 'size in points^2.\n', 'defaults': [20]}),
              ("sSequence", "basic:List",
               {'union': 's', 'docstring': 'size in points^2.\n', 'optional': True}),
              ("cmap", "basic:List",
...
Additional kwargs: hold = [True|False] overrides default hold state
    ...
    _input_ports = [
              ("barbcolor", "basic:Color",
               {'union': 'barbcolor', 'optional': True, 'docstring': 'Specifies the color all parts of the barb except any flags.  This parameter is analagous to the edgecolor parameter for polygons, which can be used instead. However this parameter will override facecolor.'}),
              ("barbcolorSequence", "basic:List",
               {'union': 'barbcolor', 'docstring': 'Specifies the color all parts of the barb except any flags.  This parameter is analagous to the edgecolor parameter for polygons, which can be used instead. However this parameter will override facecolor.', 'optional': True}),
              ("C", "basic:List",
              ...
              ("flagcolor", "basic:Color",
               {'union': 'flagcolor', 'optional': True, 'docstring': 'Specifies the color of any flags on the barb.  This parameter is analagous to the facecolor parameter for polygons, which can be used instead. However this parameter will override facecolor.  If this is not set (and C has not either) then flagcolor will be set to match barbcolor so that the barb has a uniform color. If C has been set, flagcolor has no effect.'}),
              ("flagcolorSequence", "basic:List",
               {'union': 'flagcolor', 'docstring': 'Specifies the color of any flags on the barb.  This parameter is analagous to the facecolor parameter for polygons, which can be used instead. However this parameter will override facecolor.  If this is not set (and C has not either) then flagcolor will be set to match barbcolor so that the barb has a uniform color. If C has been set, flagcolor has no effect.', 'optional': True}),

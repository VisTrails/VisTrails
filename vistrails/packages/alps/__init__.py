...
if platform.system()=='Windows':
  ...
  if platform.system()=='Darwin':
    ...
    configuration = ConfigurationObject(alpspath="C:/Program Files/VisTrails/bin",toolpath="",mpirun="['mpirun','-np']",mpiprocs=0,browser="['firefox']",archives="{}",xdisplay="",gnuplot_term="x11 enhanced")

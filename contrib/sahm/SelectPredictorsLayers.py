...
class SelectListDialog(QtWidgets.QDialog):
    ...
    def __init__(self, inputMDS, outputMDS, displayJPEG, rPath, parent=None):
        ...
        self.btnRunR = QtWidgets.QPushButton(self.widget)
        ...
        self.btnRunR.setObjectName("btnRunR")
        ...
        self.chkPresence = QtWidgets.QCheckBox(self.widget)
        self.chkPresence.setChecked(True)
        self.chkPresence.setText("Include presence/count points")
        self.chkPresence.setObjectName("chkPresence")
        self.verticalLayout.addWidget(self.chkPresence)
        self.chkAbsence = QtWidgets.QCheckBox(self.widget)
        self.chkAbsence.setChecked(True)
        self.chkAbsence.setText("Include absence points")
        self.chkAbsence.setObjectName("chkAbsence")
        self.verticalLayout.addWidget(self.chkAbsence)
        self.chkBackground = QtWidgets.QCheckBox(self.widget)
        self.chkBackground.setChecked(True)
        self.chkBackground.setText("Include background points")
        self.chkBackground.setObjectName("chkBackground")
        ...
        self.setWindowTitle("Covariate Coorelation viewer")
        self.label_2.setText("Covariates")
        self.btnRunR.setText("Update")
        ...
        self.btnOK.clicked[bool].connect(self.okTriggered)
        self.btnCancel.clicked[bool].connect(self.cancel)
        self.btnRunR.clicked[bool].connect(self.updateROutput)
...
#        shutil.copyfile(self.inputMDS, self.outputMDS)
    ...
    def PopulateTreeview(self):
        ...
        for item in headerList[3:]:
            child_item = QtWidgets.QTreeWidgetItem([item[0],])
        ...
        self.label_2.setText("Covariates   (n=" + str(n) + ")")
    ...
    def SaveMDSFromTreeview(self):
        ...
        treeviewIter = QtWidgets.QTreeWidgetItemIterator(self.treeview)

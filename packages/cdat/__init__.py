...
###################################################################################################################
    ...
    def compute(self):
        ...
        res = canvas.boxfill(slab, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createboxfill(new_GM_name, source_GM_name, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createisofill(new_GM_name, source_GM_name, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createisoline(new_GM_name, source_GM_name, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createoutfill(new_GM_name, source_GM_name, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createoutline(new_GM_name, source_GM_name, **kwargs)
...
#########################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createscatter(new_GM_name, source_GM_name, **kwargs)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createxvsy(new_GM_name, source_GM_name, **kwargs)
...
#######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createxyvsy(new_GM_name, source_GM_name, **kwargs)
...
#######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.createyxvsx(new_GM_name, source_GM_name, **kwargs)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getboxfill(GM_name, **kwargs)
        self.setResult('boxfill',res)
        self.setResult('canvas',canvas)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getisofill(GM_name, **kwargs)
        self.setResult('isofill',res)
        self.setResult('canvas',canvas)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getisoline(GM_name, **kwargs)
        self.setResult('isoline',res)
        self.setResult('canvas',canvas)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getoutfill(GM_name, **kwargs)
        self.setResult('outfill',res)
        self.setResult('canvas',canvas)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getoutline(GM_name, **kwargs)
        self.setResult('outline',res)
        self.setResult('canvas',canvas)
...
######################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getscatter(GM_name, **kwargs)
        self.setResult('scatter',res)
        self.setResult('canvas',canvas)
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getxvsy(GM_name, **kwargs)
        self.setResult('xvsy',res)
        self.setResult('canvas',canvas)
...
####################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getxyvsy(GM_name, **kwargs)
        self.setResult('xyvsy',res)
        self.setResult('canvas',canvas)
...
####################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.getyxvsx(GM_name, **kwargs)
        self.setResult('yxvsx',res)
        self.setResult('canvas',canvas)

class isofill(Module):
    """
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.isofill(slab, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)

class isoline(Module):
    """
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.isoline(slab, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.outfill(slab, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.outline(slab, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
...
###############################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.plot(slab2, slab1, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
...
###################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.scatter(slab2, slab1, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
...
#################################################################################################################
    ...
    def compute(self):
        ...
        if self.hasInputFromPort('yrev'):
            kwargs['yrev'] = self.getInputFromPort('yrev')
        res = canvas.xvsy(slab2, slab1, **kwargs)
        self.setResult('display',res)
        self.setResult('canvas',canvas)
